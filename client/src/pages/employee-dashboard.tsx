...
import { insertPassengerSchema, type InsertPassenger, type Passenger, type Ticket as TicketType, type Flight } from '@shared/schema';
            ...
            <TabsContent value="flights" className="mt-0">
              <CardContent className="p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Button data-testid="add-flight-button">
                      ...
                      <Card key={flight.id} className="hover:shadow-md transition-shadow" data-testid={`flight-card-${flight.flightNumber}`}>
                        <CardContent className="p-6">
                          ...
                          <div className="pt-4 border-t flex justify-between">
                            <Button variant="ghost" size="sm" data-testid={`edit-flight-${flight.flightNumber}`}>
                              <Edit className="mr-1 h-4 w-4" />
                              Edit
                            </Button>
                            <Button variant="ghost" size="sm" data-testid={`view-flight-${flight.flightNumber}`}>
                              <Eye className="mr-1 h-4 w-4" />
                              Details
                            </Button>
                            <Button variant="ghost" size="sm" className="text-red-500 hover:text-red-700" data-testid={`cancel-flight-${flight.flightNumber}`}>
